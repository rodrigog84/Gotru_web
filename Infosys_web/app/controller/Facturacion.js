Ext.define('Infosys_web.controller.Facturacion', {
    ...
    views: ['ventas.Ventas', 'ventas.Ejemplo','ventas.Facturas',
             'ventas.BuscarClientes','productos.BuscarProductos',
...
//
    ...
    buscarproductos: function(){
        ...
        var idbodega = viewIngresa.down('#bodegaId').getValue()
        if(!idbodega){
            Ext.Msg.alert('Alerta', 'Debe Selecionar Bodega');
            return;             
        };
        if(lista=="NO"){
            Ext.Msg.alert('Alerta', 'Debe Selecionar Cliente');
            return;             
        };
        ...
        if (!codigo){
            ...
            st.proxy.extraParams = {idlista: lista,
                                    idbodega: idbodega}
            st.load();
            var view = Ext.create('Infosys_web.view.productos.BuscarProductos').show();
