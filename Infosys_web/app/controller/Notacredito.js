Ext.define('Infosys_web.controller.Notacredito', {
    ...
    agregarItem: function() {
        ...
        var preciou = ((view.down('#precioId').getValue()));
            ...
            Ext.Ajax.request({
                ...
                success: function(response){
                   ...
                   if (resp.success == false) {
                    ...
                    view.down('#descuentoId').setValue(cero2);
            ...
            Ext.Ajax.request({
                ...
                success: function(response){
                   ...
                   if(resp.cliente){
                      ...
                      viewIngresa.down('#descuentoId').setValue(descuento);
                      view.close();
                    }
                   ...
                   if (resp.success == false) {
                    ...
                    viewIngresa.down('#descuentoId').setValue(cero2);
