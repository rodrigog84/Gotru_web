Ext.define('Infosys_web.view.caja.Facturas', {
    extend: 'Ext.window.Window',
    alias : 'widget.cajasalaingresar',
                    ...
                    items: [
                    {
...

                        {
                            ...
                            columns: [
                                ...
                                { text: 'Bodega',  dataIndex: 'id_bodega', width: 250},
                                { text: 'Precio Unitario',  dataIndex: 'precio', align: 'right',flex:1},
