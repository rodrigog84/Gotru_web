                    ...
                    items: [
                        {
                            ...
                            columns: [
                                    ...
                                    { text: 'Precio',  dataIndex: 'valor', width: 100, renderer: function(valor){return Ext.util.Format.number(parseInt(valor),"0,000")} },
                                    { text: 'Nuevo Precio',  dataIndex: 'valor_lista', flex:1, renderer: function(valor){return Ext.util.Format.number(parseInt(valor),"0,000")} }
                                ]
                            }
                    ]
                }
