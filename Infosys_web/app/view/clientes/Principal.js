Ext.define('Infosys_web.view.clientes.Principal' ,{
    ...
    columns: [{
        ...
        header: "Cobrador",
        flex: 1,
        dataIndex: 'nom_cobrador',
        hidden: true
    },{
        header: "Id Cobrador",
        flex: 1,
        dataIndex: 'id_cobrador',
        hidden: true
    },{
        header: "Repartidor",
        flex: 1,
        dataIndex: 'nom_repartidor',
        hidden: true
    },{
        header: "Id Repartidor",
        flex: 1,
        dataIndex: 'id_repartidor',
        hidden: true
    },{
        header: "Tipo Negocio",
        flex: 1,
        dataIndex: 'nom_tiponegocio',
        hidden: true
    },{
        header: "Id Tiponegocio",
        flex: 1,
