Ext.define('Ferrital_web.controller.Movimientodiario', {
    ...
    grabarcorrelativos: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Correlativo');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    editarcorrelativos: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            ...
            var edit = Ext.create('Ferrital_web.view.correlativos.Ingresar').show();
    ...
    agregarcorrelativos: function(){
        Ext.create('Ferrital_web.view.correlativos.Ingresar').show();
    },
