Ext.define('Ferrital_web.controller.General', {
    ...
    exportarexcelcodigoactividad: function(){
        ...
        window.open(preurl + 'adminServicesExcel/exportarExcelCoadtividadecon?cols='+Ext.JSON.encode(jsonCol));
    ...
    mejemplos: function(){
        ...
        Ext.create('Ferrital_web.view.ventas.Ejemplo').show();
    },
    ...
    grabarciudades: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Ciudad');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarplazas: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Plaza');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarsucursales: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Sucursal');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarcondicionesdepagos: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Cond_pag');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarbancos: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Banco');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarcodactivecon: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Cod_activ_eco');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabaragrupaciones: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Agrupaciones');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarsubfamilias: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Subfamilias');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarbodegas: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Bodegas');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarmarcas : function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.marcas');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarfamilias: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Familia');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarubicaciones: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Ubica');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarmedidas: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Medida');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarusuarios: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Usuario');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarcomunas: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Comuna');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarvendedores: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Vendedor');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarcajeros: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Cajero');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    grabarcajas: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Caja');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    editarciudades: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            ...
            var edit = Ext.create('Ferrital_web.view.ciudades.Ingresar').show();
    ...
    editarplazas: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.plazas.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarsucursales: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.sucursales.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarcondicionesdepagos: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.cond_pagos.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarbancos: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.bancos.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarcodactivecon: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.cod_activ_econ.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editaragrupaciones: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.agrupaciones.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarsubfamilias: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.subfamilias.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarbodegas: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.bodegas.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarmarcas: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.marcas.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarfamilias: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.familias.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarubicaciones: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.ubicaciones.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarmedidas: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.medidas.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarusuarios: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.usuarios.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarcomunas: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.comunas.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarvendedores: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.vendedores.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarcajeros: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.cajeros.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    editarcajas: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            var row = view.getSelectionModel().getSelection()[0];
            var edit = Ext.create('Ferrital_web.view.cajas.Ingresar').show();
            edit.down('form').loadRecord(row);
        }else{
            Ext.Msg.alert('Alerta', 'Selecciona un registro.');
            return;
    ...
    agregarciudades: function(){
        Ext.create('Ferrital_web.view.ciudades.Ingresar').show();
    },

    agregarplazas: function(){
        Ext.create('Ferrital_web.view.plazas.Ingresar').show();
    },

    agregarsucursales: function(){
        Ext.create('Ferrital_web.view.sucursales.Ingresar').show();
    },

    agregarcondicionesdepagos: function(){
        Ext.create('Ferrital_web.view.cond_pagos.Ingresar').show();
    },

    agregarbancos: function(){
        Ext.create('Ferrital_web.view.bancos.Ingresar').show();
    },

    agregarcodactivecon: function(){
        Ext.create('Ferrital_web.view.cod_activ_econ.Ingresar').show();
    },

    agregaragrupaciones: function(){
        Ext.create('Ferrital_web.view.agrupaciones.Ingresar').show();
    },

    agregarsubfamilias: function(){
        Ext.create('Ferrital_web.view.subfamilias.Ingresar').show();
    },

    agregarbodegas: function(){
        Ext.create('Ferrital_web.view.bodegas.Ingresar').show();
    },

    agregarmarcas: function(){
        Ext.create('Ferrital_web.view.marcas.Ingresar').show();
    },

    agregarfamilias: function(){
        Ext.create('Ferrital_web.view.familias.Ingresar').show();
    },


    agregarmedidas: function(){
        Ext.create('Ferrital_web.view.medidas.Ingresar').show();
    },

    agregarusuarios: function(){
        Ext.create('Ferrital_web.view.usuarios.Ingresar').show();
    },

    agregarcomunas: function(){
        Ext.create('Ferrital_web.view.comunas.Ingresar').show();

    },

    agregarvendedores: function(){
        Ext.create('Ferrital_web.view.vendedores.Ingresar').show();

    },

    agregarcajeros: function(){
        Ext.create('Ferrital_web.view.cajeros.Ingresar').show();

    },

    agregarcajas: function(){
        Ext.create('Ferrital_web.view.cajas.Ingresar').show();

    },

    agregarubicaciones: function(){
        Ext.create('Ferrital_web.view.ubicaciones.Ingresar').show();
    },    
