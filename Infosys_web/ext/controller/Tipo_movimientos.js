Ext.define('Ferrital_web.controller.Tipo_movimientos', {
    ...
    tipomovimientograbareditar: function(){
        ...
        if (values.id > 0){
            ...
            record = Ext.create('Ferrital_web.model.Tipo_movimiento');
            record.set(values);
            st.add(record);
            nuevo = true;
        }
    ...
    editartipomovimientos: function(){
        ...
        if (view.getSelectionModel().hasSelection()) {
            ...
            var edit = Ext.create('Ferrital_web.view.tipo_movimiento.Desplegar').show();
    ...
    tipomovimiento: function(){
        Ext.create('Ferrital_web.view.tipo_movimiento.Ingresar').show();
