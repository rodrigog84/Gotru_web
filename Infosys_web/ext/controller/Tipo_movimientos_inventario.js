Ext.define('Ferrital_web.controller.Tipo_movimientos_inventario', {
    ...
    desplegarmovimiento : function() {
        ...
        if (view.getSelectionModel().hasSelection()) {
            ...
            var edit = Ext.create('Ferrital_web.view.movimiento_diario_inventario.Desplegar').show();
    ...
    mmovimientoinventario: function(){
        Ext.create('Ferrital_web.view.movimiento_diario_inventario.Ingresar').show();
